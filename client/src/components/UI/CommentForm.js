    ...
    return (
        <form onSubmit={handleSubmit} className="w-full max-w-sm">
            ...
            <div className="md:flex md:items-center">
                ...
                <div className="md:w-2/3">
                    {userID && <button className="shadow bg-color1 hover:bg-color4 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="submit">
                        Comment
                    </button>}
                    {!userID && <Link className="shadow bg-color1 hover:bg-color4 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded no-underline" to="/login">
                        Comment
                    </Link>}
                </div>
            </div>
