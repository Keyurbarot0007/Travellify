            ...
            {!userInfo?.id && (
                <div>
                    <div className='h-[80vh] flex justify-center items-center px-4'>
                        <div className="">
                            <h1 className="md:text-6xl text-4xl font-bold">Unleash Your Creativity with Blogify</h1>
                            <h3 className='mt-4 md:text-4xl text-2xl text-gray-300'>Blogify - Where Your Words Come to Life</h3>
                    ...
                    <div className="md:grid md:grid-cols-2 gap-4 md:p-48 px-4 py-8 bg-[#83184335]">
                        <div className="">
                            <h1 className="md:text-6xl text-2xl leading-5">Welcome to Blogify</h1>
                        ...
                        <div>
                            <p className="md:text-2xl text-xl">Dive into a world of creativity and inspiration at Blogify. <br /> Express yourself, connect with others, and explore a universe of unique perspectives.</p>
                        </div>
                    </div>
                    ...
                    <div className="backgroundImg">
                        <div className="md:p-80 p-12 text-center bg-[#000000a1]">
                            ...
                            <p className="md:text-4xl text-xl">Join Blogify to unleash your creativity, inspire others, and be part of a vibrant blogging community that values your unique voice.</p>
                        </div>
                    </div>
                    <div>
